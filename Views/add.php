...
include_once "../Controllers/addTeamController.php";
...
<body>
    ...
    <form class="addTeam" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
        <p>Name: <input type="text" name="name"></p>
        <p>Ndeshjet: <input type="text" name="ndeshjet"></p>
        <p>Fitoret: <input type="text" name="fitoret"></p>
        <p>Humbjet: <input type="text" name="humbjet"></p>
        <p>Diferenca: <input type="text" name="diferenca"></p>
        <p>Piket: <input type="text" name="piket"></p>
        <button name="add" type="submit">Add Team</button>
    </form>
